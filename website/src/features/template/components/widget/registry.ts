...
import { SettingsFields as SelectSettingsFields } from "./select/SettingsFields";

import { Field as CheckboxField } from "./checkbox/Field";
import * as checkboxDefaults from "./checkbox/defaults";
import { SettingsFields as CheckboxSettingsFields } from "./checkbox/SettingsFields";

import { Field as RadioField } from "./radio/Field";
import * as radioDefaults from "./radio/defaults";
import { SettingsFields as RadioSettingsFields } from "./radio/SettingsFields";

import { Field as LabelField } from "./label/Field";
import * as labelDefaults from "./label/defaults";
import { SettingsFields as LabelSettingsFields } from "./label/SettingsFields";
...
import { SettingsFields as ButtonSettingsFields } from "./button/SettingsFields";
...
export const WIDGET_REGISTRY: WidgetRegistry = {
  ...
  select: {
    ...
    SettingsFields: SelectSettingsFields,
  ...
  checkbox: {
    ...
    SettingsFields: CheckboxSettingsFields,
  ...
  radio: {
    ...
    SettingsFields: RadioSettingsFields,
  ...
  label: {
    ...
    SettingsFields: LabelSettingsFields,
  ...
  button: {
    ...
    SettingsFields: ButtonSettingsFields,
