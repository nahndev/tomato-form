...
import BoardViewSetting from "@/features/board/components/display/BoardViewSetting";
  ...
  return (
    <Tabs defaultValue={BoardTabValue.SETTING} className="px-4 py-4">
      <TabsList className="w-full">
        ...
        <TabsTrigger value={BoardTabValue.VIEWS}>Views</TabsTrigger>
      ...
      <TabsContent value={BoardTabValue.VIEWS}>
        <BoardViewSetting />
      </TabsContent>
